...
export default function BranchesPage() {
 ...
 <SheetContent
 side="right"
 className="flex h-full max-h-[100dvh] w-full max-w-[100vw] flex-col gap-0 overflow-hidden border-emerald-200/50 p-0 sm:max-w-5xl "
 >
 {selectedBranch ? (
 <>
 <div
 ...
 <SheetHeader className="shrink-0 space-y-3 border-b border-emerald-200/60 bg-emerald-50/35 px-4 pb-4 pt-2 text-left sm:px-6 sm:py-4 ">
