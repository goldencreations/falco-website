...
export default function StaffTeamPage() {
 ...
 <div className="overflow-hidden rounded-xl border border-emerald-200/50 bg-gradient-to-br from-emerald-50/80 via-background to-background shadow-sm ">
 <div className="flex flex-col gap-4 border-b border-emerald-200/40 px-5 py-4 sm:flex-row sm:items-center sm:justify-between ">
 <div className="flex items-start gap-3">
 <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-emerald-700 text-white shadow-md ">
 <Building2 className="h-5 w-5" />
 </div>
 <div>
 <p className="text-[11px] font-semibold uppercase tracking-widest text-emerald-800/80 ">
 Branch operations
 </p>
 ...
 <Card className="border-emerald-100/80 shadow-none ">
