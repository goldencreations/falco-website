...
export function StaffWorkspaceSheet({
 ...
 <SheetContent
 side="right"
 className="flex h-full w-full flex-col gap-0 border-l border-emerald-200/50 bg-gradient-to-b from-emerald-50/50 via-background to-background p-0 sm:max-w-4xl "
 >
 <SheetHeader className="space-y-3 border-b border-emerald-200/60 bg-emerald-50/40 px-4 py-4 text-left sm:px-6 sm:py-5 ">
 ...
 <div className="border-b border-emerald-200/50 px-4 py-3 sm:px-6 ">
 <TabsList className="grid h-10 w-full max-w-md grid-cols-2 rounded-full bg-emerald-100/70 p-1 ">
 <TabsTrigger
 value="users"
 className="gap-2 rounded-full data-[state=active]:bg-background data-[state=active]:text-emerald-700 data-[state=active]:shadow-sm =active]:text-emerald-300"
 >
 ...
 <div className="flex flex-wrap gap-2 border-t border-emerald-200/60 bg-emerald-50/40 px-4 py-4 sm:px-6 ">
