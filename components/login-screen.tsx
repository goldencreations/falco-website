...
import { Building2, Eye, EyeOff, Globe, Languages, MoonStar, Sun } from "lucide-react";
...
export function LoginScreen() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-background to-emerald-100/40 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950/40 md:p-8">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-[2.25rem] border border-border bg-card text-card-foreground shadow-md ring-1 ring-emerald-100/70 dark:ring-emerald-900/40 md:grid-cols-[420px_1fr]">
        <section className="flex items-center px-6 py-10 md:px-10">
          <div className="w-full">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <div>
                <Label className="mb-1 block text-xs text-muted-foreground">{t.theme}</Label>
                <Select value={themeMode} onValueChange={(value: ThemeMode) => setThemeMode(value)}>
                  <SelectTrigger className="h-9 bg-background/80 dark:bg-input/40">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
